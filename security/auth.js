  ...
  basic: function(req){
     var authParts,
      ...
      if(typeof authHeader ==='undefined'){
        message = 'You have to provide \"Authorization\" Header with the following format: Basic base64(user:password) . Just admin / admin user is allowed. So send Authorization: Basic YWRtaW46YWRtaW4= where \"YWRtaW46YWRtaW4\" is base64(admin:admin)'
        return false;
      }else{
